...
function FormBus() {
  ...
  const handlerClick =(e) =>{
    ...
    let uri = 'http://34.255.239.102/api/autobus/register';
    let options ={
      method:'POST',
      headers:{
  ...
  return (
    <div className="div-bus" >
      <form className="form-bus-register" ref={form}>
        ...
        <input type="number" className="input-bus" id="asientos" name="asientos"/>
        ...
        <input type="text" className="input-bus"  id="chofer" name="chofer"/>
